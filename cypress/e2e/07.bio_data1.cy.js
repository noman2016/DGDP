...
it('Login DPGDP', function() {
  ...
  //পদবীঃ
  cy.get('#simple-tabpanel-bio-data > div > div > form > div > div > div.singleColumnRow.MuiBox-root.css-6gs9hh > div:nth-child(2) > div:nth-child(2) > div:nth-child(2) > div.MuiFormControl-root.MuiFormControl-fullWidth.css-1sbbja8 > div > div').click()
  ...
  cy.get('.formRow > .css-11ih3en > .css-1isemmb > .MuiFormGroup-root > .MuiFormControlLabel-root > .MuiButtonBase-root > .PrivateSwitchBase-input').click()

  //কর্মরত
  cy.get(':nth-child(3) > :nth-child(2) > .css-1vq3geb > .MuiBox-root > .MuiFormGroup-root > :nth-child(1) > .MuiButtonBase-root > .PrivateSwitchBase-input').click()
  cy.wait(200)
  //অবসরপ্রাপ্ত
  ...
  //স্বামী
  /*cy.get(':nth-child(4) > .css-1vq3geb > .MuiBox-root > .MuiFormGroup-root > :nth-child(1) > .MuiButtonBase-root > .PrivateSwitchBase-input').click()
  cy.wait(200)*/
  //স্ত্রী
  cy.get(':nth-child(4) > .css-1vq3geb > .MuiBox-root > .MuiFormGroup-root > :nth-child(2) > .MuiButtonBase-root > .PrivateSwitchBase-input').click()
  cy.wait(200)
  //৬। শেয়ারের পরিমান/অংশঃ*
  cy.get('input[name="sharePercentage"]').type('50')
  //৭। পিতার নামঃ*
  //cy.get('input[name="fatherName"]').type('পিতা')
  //৮। মাতার নামঃ*
  cy.get('input[name="motherName"]').type('মাতা')
  //৯। স্বামী/স্ত্রীর নামঃ
  cy.get('input[name="spouseName"]').type('স্বামী/স্ত্রী')
  //১০। জন্মতারিখঃ*
  //১১। মোবাইল নম্বরঃ*
  cy.get('input[name="phoneNo"]').type('01759784512')
  //১২। ই-মেইল নম্বরঃ*
  cy.get('input[name="email"]').type('testemail@gmail.com')
  //১৩। জাতীয় পরিচয়পত্র নংঃ*
  cy.get('input[name="nidNo"]').type('9025146532')
  //১৪। টিআইএন নম্বরঃ*
  cy.get('input[name="tinNo"]').type('45693215')
  //১৫। পাসপোর্ট নম্বর (যদি থাকে)
  cy.get(':nth-child(11) > .css-0 > .css-11ih3en > .css-1isemmb > .MuiFormGroup-root > .MuiFormControlLabel-root > .MuiButtonBase-root > .PrivateSwitchBase-input').click()
  cy.wait(200)
  cy.get('input[name="passportNo"]').type('12364555789058654')
  //প্রদানকারী কর্তৃপক্ষ*
  cy.get('input[name="passportProvider"]').type('BD')
  ...
  cy.get('.MuiPickersCalendarHeader-switchViewButton').click()
  cy.wait(200)
  cy.get(':nth-child(133) > .PrivatePickersYear-yearButton').click()
  cy.wait(200)
  cy.get('.MuiMonthPicker-root > :nth-child(7)').click()
  cy.wait(200)
  cy.get('.MuiDayPicker-monthContainer > :nth-child(3) > :nth-child(2)').click()
  ...
  cy.get('input[name="latestEducationalQualification"]').type('বিএসসি, বিএমএমপি, টিডাব্লিউএসটি')
  ...
  cy.wait(200)
  cy.get('input[name="educationalInstituteName"]').type('ইউনিভার্সিটি অফ আর্মি অটোমেশন')
  cy.wait(200)
  //১৮। বর্তমান ঠিকানাঃ
  //বিভাগঃ
  //জেলাঃ
  ...
  //বিভাগঃ
  cy.get('#mui-component-select-dhakaPermanentDivisionId').click()
  cy.contains('li.MuiMenuItem-root', 'ঢাকা').click();
  //জেলাঃ
  cy.get('#mui-component-select-dhakaPermanentDistrictId').click()
  cy.contains('li.MuiMenuItem-root', 'ঢাকা').click();
  //থানাঃ
  cy.get('#mui-component-select-dhakaPermanentThanaId').click()
  cy.contains('li.MuiMenuItem-root', 'সাভার').click();
  //বাড়ি/বাসা/হোল্ডিংঃ
  cy.get('input[name="dhakaPermanentAddressLine"]').type('বাড়ি/বাসা/হোল্ডিং')
