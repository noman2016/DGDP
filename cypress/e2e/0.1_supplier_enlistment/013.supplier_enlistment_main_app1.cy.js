...
it('Supplier Enlistment, Main Application', function() {
  ...
  cy.wait(200)
  //থানাঃ*
  cy.get('#simple-tabpanel-application-for-enlistment > div > div > form > div > div > div > div:nth-child(4) > div > div > div:nth-child(3) > div.MuiBox-root.css-11ze7cv > div.MuiFormControl-root.MuiFormControl-fullWidth.css-1sbbja8 > div > div')
  .click()
  cy.wait(200)
  ...
  //৬ । ব্যাংকের তথ্যাদি:
  //ব্যাংকের নামঃ *
  cy.get('#simple-tabpanel-application-for-enlistment > div > div > form > div > div > div > div:nth-child(7) > div.subFormContainer.MuiBox-root.css-uewl2b > div.singleColumnRow.MuiBox-root.css-0 > div:nth-child(2) > div.MuiBox-root.css-11ze7cv > div.MuiFormControl-root.MuiFormControl-fullWidth.css-1sbbja8 > div > div')
  .click()
  cy.wait(200)
  ...
  cy.wait(200)
  //থানাঃ
  cy.get('#simple-tabpanel-application-for-enlistment > div > div > form > div > div > div > div:nth-child(7) > div.subFormContainer.MuiBox-root.css-uewl2b > div.singleColumnRow.MuiBox-root.css-0 > div:nth-child(6) > div.MuiBox-root.css-11ze7cv > div.MuiFormControl-root.MuiFormControl-fullWidth.css-1sbbja8 > div > div')
  .click()
  cy.wait(200)
  cy.contains('li.MuiMenuItem-root', 'সাভার')
  .click();
  ...
  cy.get(':nth-child(16) > .css-1ltrdnm > .css-8v90jo > .MuiFormGroup-root > :nth-child(1) > .MuiButtonBase-root > .PrivateSwitchBase-input')
  .click()
  cy.wait(200)
