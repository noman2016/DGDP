...
it('Indent', function() {
  ...
  //বিতরণ
  //বহির্গমন
  cy.get('#mui-component-select-secondExternalOffice')
  .click()
  cy.wait(250)
  ...
  //অবগতি
  cy.get('input[name="secondExternalAcknowledgment"]')
  .type('অবগতি')
  cy.wait(200)

  //অভ্যন্তরীণ
  //কার্যক্রম
  cy.get('#mui-component-select-secondInternalOffice')
  .click()
  cy.wait(250)
  ...
  //অবগতি
  cy.get('input[name="secondInternalAcknowledgment"]')
  .type('অবগতি')
  cy.wait(200)
