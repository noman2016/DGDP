...
import Indent_NameCy from "../../../Pages/Indent_Name/Indent_Name.cy"
...
it('Group One - SSM', function() {
    ...
    //Action
    cy.get('#simple-tabpanel-indent-list > div > div > div.MuiBox-root.css-0 > div > div:nth-child(1) > div > div > table > tbody > tr:nth-child(4) > td.MuiTableCell-root.MuiTableCell-body.MuiTableCell-sizeMedium.css-1j6ji2h > div > div:nth-child(1)')
    .click()
    cy.wait(2500)
