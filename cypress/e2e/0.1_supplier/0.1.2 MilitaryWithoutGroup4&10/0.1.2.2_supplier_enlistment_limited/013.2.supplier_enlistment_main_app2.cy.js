...
it('Supplier Enlistment - Proprietorship', function() {
  ...
  */
  ...
  //বিভাগঃ
  cy.get('#simple-tabpanel-owner-or-supplier-information > div > form > div > div.formColumn.centerAlignItems.MuiBox-root.css-0 > div.singleColumnRow.MuiBox-root.css-6gs9hh > div:nth-child(13) > div > div:nth-child(1) > div:nth-child(1) > div.MuiFormControl-root.MuiFormControl-fullWidth.css-1sbbja8 > div > div')
  .click()
  cy.wait(200)
  ...
  //জেলাঃ
  cy.get('#simple-tabpanel-owner-or-supplier-information > div > form > div > div.formColumn.centerAlignItems.MuiBox-root.css-0 > div.singleColumnRow.MuiBox-root.css-6gs9hh > div:nth-child(13) > div > div:nth-child(1) > div:nth-child(2) > div.MuiFormControl-root.MuiFormControl-fullWidth.css-1sbbja8 > div > div')
  .click()
  cy.wait(200)
  cy.contains('li.MuiMenuItem-root', 'ঢাকা')
  .click();
  ...
  //থানাঃ
  cy.get('#simple-tabpanel-owner-or-supplier-information > div > form > div > div.formColumn.centerAlignItems.MuiBox-root.css-0 > div.singleColumnRow.MuiBox-root.css-6gs9hh > div:nth-child(13) > div > div:nth-child(2) > div.MuiBox-root.css-1mew44o > div.MuiFormControl-root.MuiFormControl-fullWidth.css-1sbbja8 > div > div')
  .click()
  cy.wait(200)
  ...
  //বাড়ি /বাসা /হোল্ডিংঃ
  cy.get('input[name="permanentAddress.addressLine"]')
  .type('বাড়ি/বাসা/হোল্ডিং');
  cy.wait(200)

  //১৭। বর্তমান ঠিকানাঃ
  cy.get('.css-bcgk97 > .css-0 > .MuiFormGroup-root > .MuiFormControlLabel-root > .MuiButtonBase-root > .PrivateSwitchBase-input')
  .click()
  cy.wait(200)
  ...
  .click();
  //থানাঃ
  cy.get('#simple-tabpanel-owner-or-supplier-information > div > form > div > div.formColumn.centerAlignItems.MuiBox-root.css-0 > div:nth-child(3) > div > div:nth-child(6) > div.MuiBox-root.css-1mew44o > div.MuiFormControl-root.MuiFormControl-fullWidth.css-1sbbja8 > div > div')
  .click()
  cy.wait(200)
  cy.contains('li.MuiMenuItem-root', 'সাভার')
  .click();
  ...
  cy.get('.css-94fa8i > .css-0 > .MuiFormGroup-root > .MuiFormControlLabel-root > .MuiButtonBase-root > .PrivateSwitchBase-input')
  .click()
  //বিভাগঃ
  //জেলাঃ
  //থানাঃ
  ...
  //থানাঃ
  cy.get('#simple-tabpanel-owner-or-supplier-information > div > form > div > div.formColumn.centerAlignItems.MuiBox-root.css-0 > div:nth-child(3) > div > div:nth-child(15) > div.MuiBox-root.css-1mew44o > div.MuiFormControl-root.MuiFormControl-fullWidth.css-1sbbja8 > div > div')
  .click()
  cy.wait(200)
  cy.contains('li.MuiMenuItem-root', 'সাভার')
  .click()
