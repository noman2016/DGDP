...
it('Supplier Enlistment - Proprietorship', function() {
  ...
  cy.get('#simple-tabpanel-bio-data-bn > div > div > form > div > div.MuiBox-root.css-7ysju6 > div > div > div:nth-child(10) > div > div.MuiBox-root.css-79elbk > div')
  .click()
  .type('বিএসসি')
  cy.wait(200)
  ...
  //১৩। বর্তমান ঠিকানাঃ
  cy.get(':nth-child(1) > .css-11ih3en > .css-0 > .MuiFormGroup-root > .MuiFormControlLabel-root > .MuiButtonBase-root > .PrivateSwitchBase-input')
  .click()
  cy.wait(300)
  //বিভাগঃ*
  //জেলাঃ*
  ...
  cy.get('#simple-tabpanel-bio-data-bn > div > div > form > div > div.MuiBox-root.css-7ysju6 > div > div > div:nth-child(16) > div.singleColumnRow.MuiBox-root.css-0 > div.MuiBox-root.css-12oq5ku > div.singleColumnRow.MuiBox-root.css-0 > div:nth-child(2) > div.MuiBox-root.css-79elbk > div')
  .click() 
  .type('প্রতিষ্ঠানের বিবরণ প্রতিষ্ঠানের বিবরণ প্রতিষ্ঠানের বিবরণ প্রতিষ্ঠানের বিবরণ প্রতিষ্ঠানের বিবরণ প্রতিষ্ঠানের বিবরণ')
  ...
  cy.get(':nth-child(18) > .css-11ih3en > .css-0 > .MuiFormGroup-root > .MuiFormControlLabel-root > .MuiButtonBase-root > .PrivateSwitchBase-input')
  .click()
  cy.wait(200)
  ...
  */
  ...
  //থানাঃ*
  cy.get('#simple-tabpanel-bio-data-bn > div > div > form > div > div.MuiBox-root.css-7ysju6 > div > div > div:nth-child(21) > div.singleColumnRow.MuiBox-root.css-0 > div.MuiBox-root.css-12oq5ku > div.MuiBox-root.css-1wdhvac > div.singleColumnRow.MuiBox-root.css-0 > div.MuiBox-root.css-7ysju6 > div:nth-child(3) > div.MuiBox-root.css-1mew44o > div.MuiFormControl-root.MuiFormControl-fullWidth.css-1sbbja8 > div')
  .click()
  cy.wait(300)
  cy.contains('li.MuiMenuItem-root', 'সাভার')
  .click();
