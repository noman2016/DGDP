...
it('Supplier Enlistment - Proprietorship', function() {
  ...
  SupplierCy.supplierUserforPartnership3.supplierUserName()
  cy.wait(300)
  //Change Password
  ...
  .selectFile('cypress/fixtures/bio_pro.jpg')
  cy.wait(2000)
  ...
  .click();
  //থানাঃ
  cy.get('#simple-tabpanel-bio-data > div > div > form > div > div.MuiBox-root.css-7ysju6 > div > div > div:nth-child(23) > div:nth-child(3) > div.MuiBox-root.css-1mew44o > div.MuiFormControl-root.MuiFormControl-fullWidth.css-1sbbja8 > div > div')
  .click()
  cy.wait(200)
  cy.contains('li.MuiMenuItem-root', 'সাভার')
  .click();
  ...
  //থানাঃ
  cy.get('#simple-tabpanel-bio-data > div > div > form > div > div.MuiBox-root.css-7ysju6 > div > div > div:nth-child(25) > div.MuiBox-root.css-164r41r > div > div:nth-child(2) > div.MuiBox-root.css-1mew44o > div.MuiFormControl-root.MuiFormControl-fullWidth.css-1sbbja8 > div > div')
  .click()
  cy.wait(200)
  cy.contains('li.MuiMenuItem-root', 'সাভার')
  .click();
  ...
  .click();
  //থানাঃ
  cy.get('#simple-tabpanel-bio-data > div > div > form > div > div.MuiBox-root.css-7ysju6 > div > div > div:nth-child(31) > div.MuiBox-root.css-12oq5ku > div:nth-child(8) > div.MuiBox-root.css-1mew44o > div.MuiFormControl-root.MuiFormControl-fullWidth.css-1sbbja8 > div > div')
  .click()
  cy.wait(200)
  cy.contains('li.MuiMenuItem-root', 'সাভার')
  .click();
