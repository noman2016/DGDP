...
it('', function() {
  ...
  //তালিকাভুক্তি
  cy.get(':nth-child(1) > .menu-card-body > :nth-child(2) > a')
  .click()
  cy.wait(250)

  //আবেদনকারীর নাম (User Search)
  SupplierCy.searchSupplierUserforAprovel2.supplierApprovalforEnlistmentMain()
  cy.wait(5000)
  ...
  //আবেদনকারীর নাম (User Search)
  SupplierCy.searchSupplierUserforAprovel2.supplierApprovalforEnlistmentMain()
  /*cy.get('#simple-tabpanel-pre-applications > div > div > div > div > div:nth-child(1) > div > div > table > tbody > tr:nth-child(1) > td:nth-child(2) > div > div > div')
  .click()
  .type('মোল্লা বছি উদ্দিন (test01cwog410lim)')*/
  cy.wait(250)
