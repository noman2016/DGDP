...
it('Supplier Enlistment - Proprietorship', function() {
  ...
  .type('Sqa@12345')*/
  SupplierCy.supplierPass2.supplierUserPass()
  cy.wait(300)
  ...
  //বিভাগঃ*
  cy.get('#simple-tabpanel-application-for-enlistment > div > div > form > div > div > div > div:nth-child(4) > div > div > div:nth-child(2) > div:nth-child(1) > div.MuiFormControl-root.MuiFormControl-fullWidth.css-1sbbja8 > div > div')
  .click()
  cy.wait(200)
  ...
  //জেলাঃ*
  cy.get('#simple-tabpanel-application-for-enlistment > div > div > form > div > div > div > div:nth-child(4) > div > div > div:nth-child(2) > div:nth-child(2) > div.MuiFormControl-root.MuiFormControl-fullWidth.css-1sbbja8 > div > div')
  .click()
  cy.wait(200)
  cy.contains('li.MuiMenuItem-root', 'ঢাকা')
  .click();
  ...
  //থানাঃ*
  cy.get('#simple-tabpanel-application-for-enlistment > div > div > form > div > div > div > div:nth-child(4) > div > div > div:nth-child(3) > div.MuiBox-root.css-512yuf > div.MuiFormControl-root.MuiFormControl-fullWidth.css-1sbbja8 > div > div')
  .click()
  cy.wait(200)
  ...
  //ব্যাংকের নামঃ *
  cy.get('#simple-tabpanel-application-for-enlistment > div > div > form > div > div > div > div:nth-child(7) > div.subFormContainer.MuiBox-root.css-uewl2b > div.singleColumnRow.MuiBox-root.css-0 > div:nth-child(2) > div.MuiBox-root.css-512yuf > div.MuiFormControl-root.MuiFormControl-fullWidth.css-1sbbja8 > div > div')
  .click()
  cy.wait(200)
  ...
  //বিভাগঃ
  cy.get('#simple-tabpanel-application-for-enlistment > div > div > form > div > div > div > div:nth-child(7) > div.subFormContainer.MuiBox-root.css-uewl2b > div.singleColumnRow.MuiBox-root.css-0 > div:nth-child(5) > div:nth-child(1) > div.MuiFormControl-root.MuiFormControl-fullWidth.css-1sbbja8 > div > div')
  .click()
  cy.wait(200)
  cy.contains('li.MuiMenuItem-root', 'ঢাকা')
  .click();
  ...
  //জেলাঃ
  cy.get('#simple-tabpanel-application-for-enlistment > div > div > form > div > div > div > div:nth-child(7) > div.subFormContainer.MuiBox-root.css-uewl2b > div.singleColumnRow.MuiBox-root.css-0 > div:nth-child(5) > div:nth-child(2) > div.MuiFormControl-root.MuiFormControl-fullWidth.css-1sbbja8 > div > div')
  .click()
  cy.wait(200)
  cy.contains('li.MuiMenuItem-root', 'ঢাকা')
  .click();
  ...
  //থানাঃ
  cy.get('#simple-tabpanel-application-for-enlistment > div > div > form > div > div > div > div:nth-child(7) > div.subFormContainer.MuiBox-root.css-uewl2b > div.singleColumnRow.MuiBox-root.css-0 > div:nth-child(6) > div.MuiBox-root.css-512yuf > div.MuiFormControl-root.MuiFormControl-fullWidth.css-1sbbja8 > div > div')
  .click()
  cy.wait(200)
  cy.contains('li.MuiMenuItem-root', 'সাভার')
  .click();
  ...
  //হ্যাঁ
  cy.get(':nth-child(9) > .css-8v90jo > .MuiFormGroup-root > :nth-child(1) > .MuiButtonBase-root > .PrivateSwitchBase-input')
  .click()
  cy.wait(200)
  //না By Default
  ...
  //থানাঃ
  cy.get('#simple-tabpanel-application-for-enlistment > div > div > form > div > div > div > div:nth-child(15) > div.subFormContainer.MuiBox-root.css-wjsf6v > div > div:nth-child(4) > div.MuiBox-root.css-512yuf > div.MuiFormControl-root.MuiFormControl-fullWidth.css-1sbbja8 > div > div')
  .click()
  cy.wait(200)
  cy.contains('li.MuiMenuItem-root', 'সাভার')
  .click();
  ...
  //প্রত্যেক অংশীদারের অংশের পরিমাণঃ *   /*** This field is obsolete ***/
  /*cy.get(':nth-child(5) > .formRow > .css-1e8ytuy > .css-0 > .MuiFormGroup-root')
  .type('70')
  cy.wait(250)*/
  ...
  //বাড়ি /বাসা /হোল্ডিংঃ
  //cy.get('input[name="proprietorshipOwnerOtherOrganizationPartnershipParams.0.addressLine"]')
  cy.get('input[name="partnershipOtherOrganizationParams.0.addressLine"]')
  .type('বাড়ি/বাসা/হোল্ডিং');
  cy.wait(200)
